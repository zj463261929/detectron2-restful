...
class DefaultTrainer(SimpleTrainer):
    ...
    def __init__(self, cfg):
        ...
        data_loader = self.build_train_loader(cfg)  #detectron2/data/build.py
    ...
    def resume_or_load(self, resume=True): 
        ...
        self.start_iter = (
            ...
            + 1
        )  #detectron2/checkpoint/detection_checkpoint.py  fvcore.common.checkpoint
    ...
    def train(self):
        ...
        """
        super().train(self.start_iter, self.max_iter) #detectron2/engine/train_loop.py
